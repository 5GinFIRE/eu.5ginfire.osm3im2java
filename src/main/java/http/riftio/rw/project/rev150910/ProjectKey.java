...
public class ProjectKey
 implements Identifier<Project> {
    ...
    public ProjectKey(java.lang.String _name) {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.rw.project.rev150910.ProjectKey.class.getSimpleName()).append(" [");
        boolean first = true;
