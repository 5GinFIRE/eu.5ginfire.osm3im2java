...
public interface Project
    ...
    Augmentable<http.riftio.rw.project.rev150910.Project>,
    Identifiable<ProjectKey>
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("http://riftio.com/ns/riftware-1.0/rw-project",
        "2015-09-10", "project").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.rw.project.rev150910.ProjectKey</code> <code>key</code>, or <code>null</code> if not present
     */
    ProjectKey getKey();
