package http.riftio.project.vnfd.rev170228.project.vnfd.catalog;
...
/**
 * Class that builds {@link http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd} instances.
 * 
 * @see http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd
 *
 */
public class VnfdBuilder implements Builder<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> augmentation = Collections.emptyMap();
    ...
    public VnfdBuilder(Vnfd base) {
        ...
        if (base instanceof VnfdImpl) {
            ...
            AugmentationHolder<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd> casted =(AugmentationHolder<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public VnfdBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> augmentationType, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd> augmentationValue) {
    ...
    public VnfdBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class VnfdImpl implements Vnfd {
        ...
        @Override
        public java.lang.Class<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd> getImplementedInterface() {
            return http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> augmentation = Collections.emptyMap();
        ...
        private VnfdImpl(VnfdBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd other = (http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>>, Augmentation<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>> e : augmentation.entrySet()) {
