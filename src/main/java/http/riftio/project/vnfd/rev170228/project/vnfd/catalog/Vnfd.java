...
public interface Vnfd
    extends
    ChildOf<VnfdCatalog>,
    Augmentable<http.riftio.project.vnfd.rev170228.project.vnfd.catalog.Vnfd>,
    VnfdDescriptor,
    Identifiable<VnfdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.vnfd.rev170228.project.vnfd.catalog.VnfdKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VnfdKey getKey();
