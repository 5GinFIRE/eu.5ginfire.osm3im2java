...
public class MonitoringParamKey
 implements Identifier<MonitoringParam> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParamKey.class.getSimpleName()).append(" [");
        boolean first = true;
