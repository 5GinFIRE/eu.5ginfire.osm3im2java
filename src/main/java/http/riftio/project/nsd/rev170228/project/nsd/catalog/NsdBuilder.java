package http.riftio.project.nsd.rev170228.project.nsd.catalog;
...
import http.riftio.project.nsd.rev170228.nsd.constituent.vnfd.ConstituentVnfd;
import http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam;
...
import http.riftio.project.nsd.rev170228.nsd.vld.Vld;
import http.riftio.project.nsd.rev170228.nsd.vnf.dependency.VnfDependency;
...
/**
 * Class that builds {@link http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd} instances.
 * 
 * @see http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd
 *
 */
public class NsdBuilder implements Builder<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> augmentation = Collections.emptyMap();

    public NsdBuilder() {
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdMonitoringParam arg) {
        this._monitoringParam = arg.getMonitoringParam();
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdVnfDependency arg) {
        this._vnfDependency = arg.getVnfDependency();
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdConstituentVnfd arg) {
        this._constituentVnfd = arg.getConstituentVnfd();
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdPlacementGroups arg) {
        this._placementGroups = arg.getPlacementGroups();
    }
    public NsdBuilder(http.riftio.project.nsd.rev170228.NsdServicePrimitive arg) {
    ...
    public NsdBuilder(Nsd base) {
        ...
        if (base instanceof NsdImpl) {
            ...
            AugmentationHolder<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd> casted =(AugmentationHolder<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>) base;
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdConstituentVnfd) {
            this._constituentVnfd = ((http.riftio.project.nsd.rev170228.NsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        ...
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdMonitoringParam) {
            this._monitoringParam = ((http.riftio.project.nsd.rev170228.NsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdPlacementGroups) {
            this._placementGroups = ((http.riftio.project.nsd.rev170228.NsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdVnfDependency) {
            this._vnfDependency = ((http.riftio.project.nsd.rev170228.NsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdServicePrimitive) {
            this._servicePrimitive = ((http.riftio.project.nsd.rev170228.NsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        if (arg instanceof http.riftio.project.nsd.rev170228.NsdVld) {
            this._vld = ((http.riftio.project.nsd.rev170228.NsdVld)arg).getVld();
            isValidArg = true;
        }
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVld] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public NsdBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> augmentationType, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd> augmentationValue) {
    ...
    public NsdBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class NsdImpl implements Nsd {
        ...
        @Override
        public java.lang.Class<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd> getImplementedInterface() {
            return http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> augmentation = Collections.emptyMap();
        ...
        private NsdImpl(NsdBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd other = (http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>>, Augmentation<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>> e : augmentation.entrySet()) {
