...
/**
 * Class that builds {@link http.riftio.project.nsd.rev170228.nsd.vld.Vld} instances.
 * 
 * @see http.riftio.project.nsd.rev170228.nsd.vld.Vld
 *
 */
public class VldBuilder implements Builder<http.riftio.project.nsd.rev170228.nsd.vld.Vld> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> augmentation = Collections.emptyMap();
    ...
    public VldBuilder(Vld base) {
        ...
        if (base instanceof VldImpl) {
            ...
            AugmentationHolder<http.riftio.project.nsd.rev170228.nsd.vld.Vld> casted =(AugmentationHolder<http.riftio.project.nsd.rev170228.nsd.vld.Vld>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public VldBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> augmentationType, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld> augmentationValue) {
    ...
    public VldBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class VldImpl implements Vld {
        ...
        @Override
        public java.lang.Class<http.riftio.project.nsd.rev170228.nsd.vld.Vld> getImplementedInterface() {
            return http.riftio.project.nsd.rev170228.nsd.vld.Vld.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> augmentation = Collections.emptyMap();
        ...
        private VldImpl(VldBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.project.nsd.rev170228.nsd.vld.Vld.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.project.nsd.rev170228.nsd.vld.Vld other = (http.riftio.project.nsd.rev170228.nsd.vld.Vld)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.vld.Vld>> e : augmentation.entrySet()) {
