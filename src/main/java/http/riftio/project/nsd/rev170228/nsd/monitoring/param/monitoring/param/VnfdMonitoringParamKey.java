...
public class VnfdMonitoringParamKey
 implements Identifier<VnfdMonitoringParam> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.project.nsd.rev170228.nsd.monitoring.param.monitoring.param.VnfdMonitoringParamKey.class.getSimpleName()).append(" [");
        boolean first = true;
