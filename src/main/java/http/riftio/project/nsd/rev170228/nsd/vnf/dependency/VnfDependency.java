...
import http.riftio.project.nsd.rev170228.NsdVnfDependency;
...
public interface VnfDependency
    ...
    Augmentable<http.riftio.project.nsd.rev170228.nsd.vnf.dependency.VnfDependency>,
    Identifiable<VnfDependencyKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.nsd.vnf.dependency.VnfDependencyKey</code> <code>key</code>, or <code>null</code> if not present
     */
