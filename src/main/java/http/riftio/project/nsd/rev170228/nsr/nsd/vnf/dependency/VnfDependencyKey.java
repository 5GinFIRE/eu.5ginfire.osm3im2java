...
public class VnfDependencyKey
 implements Identifier<VnfDependency> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.project.nsd.rev170228.nsr.nsd.vnf.dependency.VnfDependencyKey.class.getSimpleName()).append(" [");
        boolean first = true;
