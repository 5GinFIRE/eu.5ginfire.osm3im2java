...
public class ServicePrimitiveKey
 implements Identifier<ServicePrimitive> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.project.nsd.rev170228.nsd.service.primitive.ServicePrimitiveKey.class.getSimpleName()).append(" [");
        boolean first = true;
