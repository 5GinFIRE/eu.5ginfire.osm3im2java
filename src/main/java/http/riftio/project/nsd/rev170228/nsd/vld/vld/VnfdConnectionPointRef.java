...
public interface VnfdConnectionPointRef
    extends
    ChildOf<Vld>,
    Augmentable<http.riftio.project.nsd.rev170228.nsd.vld.vld.VnfdConnectionPointRef>,
    Identifiable<VnfdConnectionPointRefKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.nsd.vld.vld.VnfdConnectionPointRefKey</code> <code>key</code>, or <code>null</code> if not present
     */
