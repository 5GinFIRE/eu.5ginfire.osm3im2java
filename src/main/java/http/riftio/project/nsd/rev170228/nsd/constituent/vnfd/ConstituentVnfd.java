...
import http.riftio.project.nsd.rev170228.NsdConstituentVnfd;
...
public interface ConstituentVnfd
    ...
    Augmentable<http.riftio.project.nsd.rev170228.nsd.constituent.vnfd.ConstituentVnfd>,
    Identifiable<ConstituentVnfdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.nsd.constituent.vnfd.ConstituentVnfdKey</code> <code>key</code>, or <code>null</code> if not present
     */
