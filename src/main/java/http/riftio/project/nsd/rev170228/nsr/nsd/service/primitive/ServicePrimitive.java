...
import http.riftio.project.nsd.rev170228.NsrNsdServicePrimitive;
...
public interface ServicePrimitive
    ...
    Augmentable<http.riftio.project.nsd.rev170228.nsr.nsd.service.primitive.ServicePrimitive>,
    UiPrimitiveGroup,
    Identifiable<ServicePrimitiveKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.service.primitive.ServicePrimitiveKey</code> <code>key</code>, or <code>null</code> if not present
     */
