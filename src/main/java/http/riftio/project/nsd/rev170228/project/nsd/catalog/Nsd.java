...
import http.riftio.project.nsd.rev170228.NsdDescriptor;
...
public interface Nsd
    extends
    ChildOf<NsdCatalog>,
    Augmentable<http.riftio.project.nsd.rev170228.project.nsd.catalog.Nsd>,
    NsdDescriptor,
    Identifiable<NsdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.project.nsd.catalog.NsdKey</code> <code>key</code>, or <code>null</code> if not present
     */
    NsdKey getKey();
