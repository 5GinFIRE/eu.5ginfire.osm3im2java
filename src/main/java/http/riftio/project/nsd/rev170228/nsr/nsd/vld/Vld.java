...
import http.riftio.project.nsd.rev170228.NsrNsdVld;
...
public interface Vld
    extends
    ChildOf<NsrNsdVld>,
    Augmentable<http.riftio.project.nsd.rev170228.nsr.nsd.vld.Vld>,
    NsdVldCommon,
    Identifiable<VldKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.vld.VldKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VldKey getKey();
