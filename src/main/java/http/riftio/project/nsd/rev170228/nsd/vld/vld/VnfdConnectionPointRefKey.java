...
public class VnfdConnectionPointRefKey
 implements Identifier<VnfdConnectionPointRef> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.project.nsd.rev170228.nsd.vld.vld.VnfdConnectionPointRefKey.class.getSimpleName()).append(" [");
        boolean first = true;
