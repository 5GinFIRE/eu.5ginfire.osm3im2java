package http.riftio.project.nsd.rev170228.nsd.monitoring.param;
...
import http.riftio.project.nsd.rev170228.nsd.monitoring.param.monitoring.param.VnfdMonitoringParam;
...
/**
 * Class that builds {@link http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam} instances.
 * 
 * @see http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam
 *
 */
public class MonitoringParamBuilder implements Builder<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> augmentation = Collections.emptyMap();
    ...
    public MonitoringParamBuilder(MonitoringParam base) {
        ...
        if (base instanceof MonitoringParamImpl) {
            ...
            AugmentationHolder<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam> casted =(AugmentationHolder<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public MonitoringParamBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> augmentationType, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam> augmentationValue) {
    ...
    public MonitoringParamBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class MonitoringParamImpl implements MonitoringParam {
        ...
        @Override
        public java.lang.Class<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam> getImplementedInterface() {
            return http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> augmentation = Collections.emptyMap();
        ...
        private MonitoringParamImpl(MonitoringParamBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam other = (http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>>, Augmentation<http.riftio.project.nsd.rev170228.nsd.monitoring.param.MonitoringParam>> e : augmentation.entrySet()) {
