...
/**
 * Class that builds {@link http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes} instances.
 * 
 * @see http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes
 *
 */
public class VolumesBuilder implements Builder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> augmentation = Collections.emptyMap();
    ...
    public VolumesBuilder(Volumes base) {
        ...
        if (base instanceof VolumesImpl) {
            ...
            AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes> casted =(AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public VolumesBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> augmentationType, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes> augmentationValue) {
    ...
    public VolumesBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class VolumesImpl implements Volumes {
        ...
        @Override
        public java.lang.Class<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes> getImplementedInterface() {
            return http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> augmentation = Collections.emptyMap();
        ...
        private VolumesImpl(VolumesBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes other = (http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes>> e : augmentation.entrySet()) {
