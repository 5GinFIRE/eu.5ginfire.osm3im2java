...
/**
 * Class that builds {@link http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration} instances.
 * 
 * @see http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration
 *
 */
public class VduConfigurationBuilder implements Builder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration> {
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> augmentation = Collections.emptyMap();
    ...
    public VduConfigurationBuilder(VduConfiguration base) {
        ...
        if (base instanceof VduConfigurationImpl) {
            ...
            AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration> casted =(AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public VduConfigurationBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> augmentationType, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration> augmentationValue) {
    ...
    public VduConfigurationBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class VduConfigurationImpl implements VduConfiguration {
        ...
        @Override
        public java.lang.Class<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration> getImplementedInterface() {
            return http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> augmentation = Collections.emptyMap();
        ...
        private VduConfigurationImpl(VduConfigurationBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration other = (http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration>> e : augmentation.entrySet()) {
