...
/**
 * Class that builds {@link http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint} instances.
 * 
 * @see http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint
 *
 */
public class InternalConnectionPointBuilder implements Builder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint> {

    private java.lang.String _id;
    private java.lang.String _internalVldRef;
    ...
    Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> augmentation = Collections.emptyMap();
    ...
    public InternalConnectionPointBuilder(InternalConnectionPoint base) {
        ...
        if (base instanceof InternalConnectionPointImpl) {
            ...
            AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint> casted =(AugmentationHolder<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>) base;
    ...
    */
    ...
    public java.lang.String getInternalVldRef() {
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public InternalConnectionPointBuilder setInternalVldRef(final java.lang.String value) {
    ...
    public InternalConnectionPointBuilder addAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> augmentationType, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint> augmentationValue) {
    ...
    public InternalConnectionPointBuilder removeAugmentation(java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    public static final class InternalConnectionPointImpl implements InternalConnectionPoint {
        ...
        private Map<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> augmentation = Collections.emptyMap();
        ...
        private InternalConnectionPointImpl(InternalConnectionPointBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint other = (http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>>, Augmentation<http.riftio.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint>> e : augmentation.entrySet()) {
        ...
        public java.lang.String toString() {
            ...
            if (_internalVldRef != null) {
                builder.append("_internalVldRef=");
                builder.append(_internalVldRef);
                builder.append(", ");
            }
            if (_key != null) {
