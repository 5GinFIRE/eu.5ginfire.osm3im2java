...
public class ConnectionPointKey
 implements Identifier<ConnectionPoint> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(http.riftio.vnfd.base.rev170228.vnfd.descriptor.ConnectionPointKey.class.getSimpleName()).append(" [");
        boolean first = true;
