...
public interface KeyPair
    extends
    ChildOf<User>,
    Augmentable<http.riftio.nsd.base.rev170228.nsd.descriptor.common.user.KeyPair>,
    Identifiable<KeyPairKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.nsd.descriptor.common.user.KeyPairKey</code> <code>key</code>, or <code>null</code> if not present
     */
    KeyPairKey getKey();
