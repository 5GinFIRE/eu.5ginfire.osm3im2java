 ...
 * 
 * <p>To create instances of this class use {@link TopologyTypesBuilder}.
 * @see TopologyTypesBuilder
 *
 */
public interface TopologyTypes
    extends
    ChildOf<Topology>,
    Augmentable<network.topology.rev131021.network.topology.topology.TopologyTypes>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:TBD:params:xml:ns:yang:network-topology",
        "2013-10-21", "topology-types").intern();
