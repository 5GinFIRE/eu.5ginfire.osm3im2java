...
public interface Nsr
    ...
    Augmentable<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config.Nsr>,
    ...
    Identifiable<NsrKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config.NsrKey</code> <code>key</code>, or <code>null</code> if not present
     */
    NsrKey getKey();
