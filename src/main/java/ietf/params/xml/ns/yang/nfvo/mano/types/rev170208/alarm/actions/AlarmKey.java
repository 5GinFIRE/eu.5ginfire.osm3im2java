...
public class AlarmKey
 implements Identifier<Alarm> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.alarm.actions.AlarmKey.class.getSimpleName()).append(" [");
        boolean first = true;
