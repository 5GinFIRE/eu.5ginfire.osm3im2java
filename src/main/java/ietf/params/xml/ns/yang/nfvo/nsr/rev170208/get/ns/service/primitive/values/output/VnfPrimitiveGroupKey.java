...
public class VnfPrimitiveGroupKey
 implements Identifier<VnfPrimitiveGroup> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.get.ns.service.primitive.values.output.VnfPrimitiveGroupKey.class.getSimpleName()).append(" [");
        boolean first = true;
