...
/**
 * Class that builds {@link ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps} instances.
 * 
 * @see ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps
 *
 */
public class VnfdPlacementGroupMapsBuilder implements Builder<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps> {
    ...
    Map<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> augmentation = Collections.emptyMap();
    ...
    public VnfdPlacementGroupMapsBuilder(VnfdPlacementGroupMaps base) {
        ...
        if (base instanceof VnfdPlacementGroupMapsImpl) {
            ...
            AugmentationHolder<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps> casted =(AugmentationHolder<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public VnfdPlacementGroupMapsBuilder addAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> augmentationType, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps> augmentationValue) {
    ...
    public VnfdPlacementGroupMapsBuilder removeAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class VnfdPlacementGroupMapsImpl implements VnfdPlacementGroupMaps {
        ...
        @Override
        public java.lang.Class<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps> getImplementedInterface() {
            return ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> augmentation = Collections.emptyMap();
        ...
        private VnfdPlacementGroupMapsImpl(VnfdPlacementGroupMapsBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps other = (ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.VnfdPlacementGroupMaps>> e : augmentation.entrySet()) {
