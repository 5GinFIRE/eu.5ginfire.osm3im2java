...
import ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.VirtualInterface;
...
public interface Interface
    extends
    ChildOf<Vdur>,
    Augmentable<ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.Interface>,
    VirtualInterface,
    Identifiable<InterfaceKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.InterfaceKey</code> <code>key</code>, or <code>null</code> if not present
     */
    InterfaceKey getKey();
