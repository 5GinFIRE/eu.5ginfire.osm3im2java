...
/**
 * Class that builds {@link ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam} instances.
 * 
 * @see ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam
 *
 */
public class MonitoringParamBuilder implements Builder<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam> {
    ...
    Map<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>>, Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> augmentation = Collections.emptyMap();
    ...
    public MonitoringParamBuilder(MonitoringParam base) {
        ...
        if (base instanceof MonitoringParamImpl) {
            ...
            AugmentationHolder<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam> casted =(AugmentationHolder<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>) base;
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public MonitoringParamBuilder addAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> augmentationType, Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam> augmentationValue) {
    ...
    public MonitoringParamBuilder removeAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    public static final class MonitoringParamImpl implements MonitoringParam {
        ...
        private MonitoringParamImpl(MonitoringParamBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>>, Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>>, Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam other = (ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>>, Augmentation<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParam>> e : augmentation.entrySet()) {
