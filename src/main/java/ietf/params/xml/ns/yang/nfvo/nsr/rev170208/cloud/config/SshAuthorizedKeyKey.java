...
public class SshAuthorizedKeyKey
 implements Identifier<SshAuthorizedKey> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.cloud.config.SshAuthorizedKeyKey.class.getSimpleName()).append(" [");
        boolean first = true;
