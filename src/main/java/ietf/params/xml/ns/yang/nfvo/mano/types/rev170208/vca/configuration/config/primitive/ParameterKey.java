...
public class ParameterKey
 implements Identifier<Parameter> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.primitive.ParameterKey.class.getSimpleName()).append(" [");
        boolean first = true;
