...
public class TerminationPointKey
 implements Identifier<TerminationPoint> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.ietf.network.topology.rev150608.network.node.TerminationPointKey.class.getSimpleName()).append(" [");
        boolean first = true;
