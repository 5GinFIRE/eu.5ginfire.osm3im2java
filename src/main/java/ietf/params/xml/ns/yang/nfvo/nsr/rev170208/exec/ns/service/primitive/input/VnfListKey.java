...
public class VnfListKey
 implements Identifier<VnfList> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.exec.ns.service.primitive.input.VnfListKey.class.getSimpleName()).append(" [");
        boolean first = true;
