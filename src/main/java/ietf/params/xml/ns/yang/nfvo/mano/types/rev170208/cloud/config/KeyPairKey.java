...
public class KeyPairKey
 implements Identifier<KeyPair> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.cloud.config.KeyPairKey.class.getSimpleName()).append(" [");
        boolean first = true;
