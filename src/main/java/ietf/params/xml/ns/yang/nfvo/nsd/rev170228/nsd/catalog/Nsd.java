...
public interface Nsd
    extends
    ChildOf<NsdCatalog>,
    Augmentable<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>,
    NsdMonitoringParam,
    NsdServicePrimitive,
    NsdVld,
    NsdConstituentVnfd,
    ...
    Identifiable<NsdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.NsdKey</code> <code>key</code>, or <code>null</code> if not present
     */
    NsdKey getKey();
