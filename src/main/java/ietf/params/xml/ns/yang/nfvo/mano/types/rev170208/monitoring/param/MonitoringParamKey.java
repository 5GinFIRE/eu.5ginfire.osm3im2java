...
public class MonitoringParamKey
 implements Identifier<MonitoringParam> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.monitoring.param.MonitoringParamKey.class.getSimpleName()).append(" [");
        boolean first = true;
