...
import ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.Project1;
...
public interface VnfrCatalog
    extends
    ChildOf<Project1>,
    Augmentable<ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.project.VnfrCatalog>
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:ietf:params:xml:ns:yang:nfvo:vnfr",
        "2017-02-28", "vnfr-catalog").intern();
