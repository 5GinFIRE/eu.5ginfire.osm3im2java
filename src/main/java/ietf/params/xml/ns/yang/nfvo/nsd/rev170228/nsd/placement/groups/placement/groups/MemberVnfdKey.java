...
public class MemberVnfdKey
 implements Identifier<MemberVnfd> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.placement.groups.placement.groups.MemberVnfdKey.class.getSimpleName()).append(" [");
        boolean first = true;
