...
public class InterfaceKey
 implements Identifier<Interface> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.InterfaceKey.class.getSimpleName()).append(" [");
        boolean first = true;
