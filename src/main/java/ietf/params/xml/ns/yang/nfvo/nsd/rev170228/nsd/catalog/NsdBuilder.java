package ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog;
...
/**
 * Class that builds {@link ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd} instances.
 * 
 * @see ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd
 *
 */
public class NsdBuilder implements Builder<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd> {
    ...
    Map<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> augmentation = Collections.emptyMap();

    public NsdBuilder() {
    }
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam arg) {
        this._monitoringParam = arg.getMonitoringParam();
    }
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive arg) {
        this._servicePrimitive = arg.getServicePrimitive();
    }
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd arg) {
        this._constituentVnfd = arg.getConstituentVnfd();
    }
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups arg) {
    ...
    public NsdBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency arg) {
    ...
    public NsdBuilder(Nsd base) {
        ...
        if (base instanceof NsdImpl) {
            ...
            AugmentationHolder<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd> casted =(AugmentationHolder<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>) base;
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld) {
            this._vld = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld)arg).getVld();
            isValidArg = true;
        }
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd) {
            this._constituentVnfd = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups) {
            this._placementGroups = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        ...
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam) {
            this._monitoringParam = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        ...
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive) {
            this._servicePrimitive = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        if (arg instanceof ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency) {
            this._vnfDependency = ((ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public NsdBuilder addAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> augmentationType, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd> augmentationValue) {
    ...
    public NsdBuilder removeAugmentation(java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class NsdImpl implements Nsd {
        ...
        public java.lang.Class<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd> getImplementedInterface() {
            return ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> augmentation = Collections.emptyMap();
        ...
        private NsdImpl(NsdBuilder base) {
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd other = (ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>>, Augmentation<ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.catalog.Nsd>> e : augmentation.entrySet()) {
