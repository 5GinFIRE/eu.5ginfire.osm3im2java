...
public class ParameterKey
 implements Identifier<Parameter> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.service.primitive.ParameterKey.class.getSimpleName()).append(" [");
        boolean first = true;
