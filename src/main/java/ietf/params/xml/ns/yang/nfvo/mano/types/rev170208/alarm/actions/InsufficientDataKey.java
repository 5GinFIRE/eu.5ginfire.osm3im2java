...
public class InsufficientDataKey
 implements Identifier<InsufficientData> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.alarm.actions.InsufficientDataKey.class.getSimpleName()).append(" [");
        boolean first = true;
