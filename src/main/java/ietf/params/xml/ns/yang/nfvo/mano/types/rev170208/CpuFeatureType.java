...
public enum CpuFeatureType {
    ...
    private static final java.util.Map<java.lang.Integer, CpuFeatureType> VALUE_MAP;

    static {
        final com.google.common.collect.ImmutableMap.Builder<java.lang.Integer, CpuFeatureType> b = com.google.common.collect.ImmutableMap.builder();
    ...
    private CpuFeatureType(int value, java.lang.String name) {
        this.value = value;
        this.name = name;
    }
     ...
     * @return corresponding CpuFeatureType item
     */
    public static CpuFeatureType forValue(int valueArg) {
