...
import ietf.params.xml.ns.yang.nfvo.vnfd.rev170228.VnfdCatalog;
...
public interface Vnfd
    extends
    ChildOf<VnfdCatalog>,
    Augmentable<ietf.params.xml.ns.yang.nfvo.vnfd.rev170228.vnfd.catalog.Vnfd>,
    VnfdDescriptor,
    Identifiable<VnfdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev170228.vnfd.catalog.VnfdKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VnfdKey getKey();
