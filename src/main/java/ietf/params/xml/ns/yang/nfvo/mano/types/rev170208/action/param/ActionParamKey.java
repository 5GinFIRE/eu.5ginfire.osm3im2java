...
public class ActionParamKey
 implements Identifier<ActionParam> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.action.param.ActionParamKey.class.getSimpleName()).append(" [");
        boolean first = true;
