...
public interface KeyPair
    extends
    ChildOf<User>,
    Augmentable<ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.cloud.config.user.KeyPair>,
    Identifiable<KeyPairKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.cloud.config.user.KeyPairKey</code> <code>key</code>, or <code>null</code> if not present
     */
    KeyPairKey getKey();
