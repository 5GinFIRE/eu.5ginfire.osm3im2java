...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final java.lang.String name = "ietf-l2-topology";
    private final java.lang.String namespace = "urn:ietf:params:xml:ns:yang:ietf-l2-topology";
    private final java.lang.String revision = "2015-06-23";
    private final java.lang.String resourcePath = "/META-INF/yang/ietf-l2-topology@2015-06-23.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(ietf.params.xml.ns.yang.ietf.network.topology.rev150608.$YangModuleInfoImpl.getInstance());
        ...
        set.add(ietf.params.xml.ns.yang.ietf.network.rev150608.$YangModuleInfoImpl.getInstance());
