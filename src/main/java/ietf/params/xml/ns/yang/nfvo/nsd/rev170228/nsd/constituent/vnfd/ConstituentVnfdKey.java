...
public class ConstituentVnfdKey
 implements Identifier<ConstituentVnfd> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.constituent.vnfd.ConstituentVnfdKey.class.getSimpleName()).append(" [");
        boolean first = true;
