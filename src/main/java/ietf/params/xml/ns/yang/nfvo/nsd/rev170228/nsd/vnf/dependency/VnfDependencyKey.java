...
public class VnfDependencyKey
 implements Identifier<VnfDependency> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsd.rev170228.nsd.vnf.dependency.VnfDependencyKey.class.getSimpleName()).append(" [");
        boolean first = true;
