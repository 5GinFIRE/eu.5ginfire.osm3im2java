...
public class VnfdPlacementGroupMapsKey
 implements Identifier<VnfdPlacementGroupMaps> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.start.network.service.input.VnfdPlacementGroupMapsKey.class.getSimpleName()).append(" [");
        boolean first = true;
