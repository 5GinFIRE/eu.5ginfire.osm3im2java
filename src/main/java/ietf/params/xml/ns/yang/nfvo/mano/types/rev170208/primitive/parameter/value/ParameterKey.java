...
public class ParameterKey
 implements Identifier<Parameter> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.primitive.parameter.value.ParameterKey.class.getSimpleName()).append(" [");
        boolean first = true;
