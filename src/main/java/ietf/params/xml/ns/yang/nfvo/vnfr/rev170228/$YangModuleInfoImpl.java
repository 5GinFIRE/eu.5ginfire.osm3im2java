...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final java.lang.String name = "vnfr";
    private final java.lang.String namespace = "urn:ietf:params:xml:ns:yang:nfvo:vnfr";
    private final java.lang.String revision = "2017-02-28";
    private final java.lang.String resourcePath = "/META-INF/yang/vnfr@2017-02-28.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(http.riftio.vnfd.base.rev170228.$YangModuleInfoImpl.getInstance());
