...
public class ParameterGroupKey
 implements Identifier<ParameterGroup> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.config.agent.job.ParameterGroupKey.class.getSimpleName()).append(" [");
        boolean first = true;
